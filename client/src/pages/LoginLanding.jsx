  ...
  const portalOptions = [
    {
      to: "/login/admin",
      title: "Admin Portal",
      description: "Access the admin dashboar d and manage the system.",
      icon: ShieldIcon,
    },
    {
      to: "/login/employee",
      title: "Employee Portal",
      description: "Access your employee dashboard and manage your tasks.",
      icon: UserIcon,
    },
  ];
  return (
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen ">
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-400 ">
            <p>
              © {new Date().getFullYear()} Employee Management System. All
              rights
            </p>
          </div>
        </div>
