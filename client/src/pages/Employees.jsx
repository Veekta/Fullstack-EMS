    ...
    <div className="animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        <div className="relative flex-1">
          <Search
            className="absolute left-3.5 top-1/2 transform
      ...
      {loading ? (
        <div className="flex justify-center p-12">
          <div
            className="animate-spin h-8 w-8 border-2 border-indigo-600 border-t-transparent 
          rounded-full
          "
          ></div>
        </div>
      ...
      {showCreateModal && (
        <div
          className="fixed bg-black/40 backdrop-blur-sm inset-0 z-50 
            ...
            <div className="flex items-center justify-between p-6 pb-0">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-0.5">
                  Create a user accout and employee profile
                </p>
              </div>
      ...
      {editEmployee && (
        ...
        >
          <div
            className="relative bg-white rounded-2xl shadow2xl w-full
          max-w-3xl my-8 animate-fade-in
          "
            onClick={(e) => e.stopPropagation()}
          >
            <div className="flex items-center justify-between p-6 pb-0">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-0.5">
                  Edit a user accout and employee profile
                </p>
              </div>
