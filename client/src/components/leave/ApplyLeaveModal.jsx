    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 pb-0">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg hover:bg-slate-100 transition-colors text-slate-400 hover:trext-slate-600 "
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <span className="block tect-xs text-slate-400 mb-1">From</span>
                <input type="date" name="startDate" required min={minDate} />
              </div>
              <div>
                <span className="block tect-xs text-slate-400 mb-1">To</span>
