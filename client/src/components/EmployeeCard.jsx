  ...
  return (
    <div className="group relative card card-hover overflow-hidden">
      ...
      <div className="absolute top-3 left-3 flex gap-2">
        <span
          className="
        bg-white/90 backdrop-blur-sm px-2.5 py-1 text-xs font-semibold text-slate-600 rounded-lg shadow-sm
        "
        >
      ...
      {!employee.isDeleted && (
        <div
          className="absolute inset-0 bg-linear-to-t from-indigo-700/20 
        ...
        >
          ...
          hover:text-indigo-600 rounded-xl shadow-lg transition-all hover:scale-105
          "
          >
          ...
          <button
            ...
            className="p-2.5 bg-white/90 backdrop-blur-sm text-slate-700 
          hover:text-rose-600 rounded-xl shadow-lg transition-all hover:scale-105 
          disabled:opacity-50
          "
          >
