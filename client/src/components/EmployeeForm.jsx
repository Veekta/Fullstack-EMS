  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl">
      ...
      <div className="card p-5 sm:p-6">
        <h3 className="font-medium mb-6 pb-4 max-w-3xl">
          {" "}
          Personal Information
        </h3>
        <div
        ...
        >
          ...
          <div className="sm:col-span-2">
            <label className="sm:col-span-2">Bio (Optional)</label>
            <textarea
              name="bio"
      ...
      <div className="card p-5 sm:p-6">
        <h3
          className="text-base font-medium text-slate-900 mb-6 pb-4 border-b
        border-slate-100
        "
        >
          Employment Details
      ...
      {/* Account setup */}
      <div className="card p-5 sm:p-6">
        <h3 className="font-base mb-6 pb-4 border-b border-slate-100 ">
          {" "}
          Account Setup
        </h3>
        <div
